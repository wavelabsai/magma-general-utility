...
F.1. Additional debugging (Disruptive)
      ...
      4.2 Restarting the services
      ----------------------------
      sudo service magma@* stop
      sudo service magma@magmad start
      
      4.3 All the logs will be captured in syslogs
      
      4.5 Once the test is complete we need to turn the flag to false "magma_print_grpc_payload: false"
